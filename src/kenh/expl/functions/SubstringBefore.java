...
/**
 * Gets the substring before a separator.
 * 
 * @author Kenneth
 * @since 1.0
 * 
 ...
 *
 */
public class SubstringBefore extends BaseFunction {
	...
	public String process(String str, String open, boolean last) {
		if(last) return StringUtils.substringBeforeLast(str, open);
		else return StringUtils.substringBefore(str, open);
	}
}
