...
/**
 * Returns either the passed in String, or if the CharSequence is
 * empty or {@code null}, the value of default value.
 * 
 * @author Kenneth
 * @since 1.0
 * 
 ...
 *
 */
public class DefaultIfEmpty extends BaseFunction {
